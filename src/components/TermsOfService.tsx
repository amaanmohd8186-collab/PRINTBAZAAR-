      ...
      <div className="bg-white rounded-[32px] border border-zinc-200/80 p-6 md:p-8 shadow-sm space-y-8">
        ...
        <div className="space-y-8 text-zinc-700 leading-relaxed font-sans text-sm">
          ...
          <div className="space-y-3">
            ...
            <p>
              Welcome to the PRINTBAZAAR platform. This User Agreement ("Agreement") constitutes a legally binding contract between you ("User", "you", or "your") and PRINTBAZAAR. By accessing, registering for, or using our online marketplace, services, and digital editing tools, you agree to be bound by these Terms.
            </p>
            <p>
          ...
          <div className="space-y-3">
            ...
            <p>
              Our marketplace operates as a high-volume professional production network. By publishing products, customization configurations, or uploading graphics, you warrant and pledge that:
            </p>
            <ul className="list-disc pl-5 space-y-2 text-zinc-650">
              <li>
                <strong>Ownership Rights:</strong> You own or hold the explicit commercial license for all images, typography vectors, logomarks, and artwork uploaded to the Design Studio or customization workspace.
              </li>
              <li>
              ...
              <li>
                <strong>Design Accuracy:</strong> All layouts submitted must conform to specified bleed boundaries (default 3mm outer threshold margins) and resolution constraints (minimum quality standards for standard production).
              </li>
            </ul>
          </div>
          ...
          <div className="space-y-3">
            <h4 className="text-base font-heavy text-slate-900 uppercase tracking-tight flex items-center gap-2">
              ...
              Mandatory Payment Policy (No-COD)
            </h4>
            <div className="p-4 bg-[#ffe4d6] border border-[#FF4D00]/20 rounded-2xl text-neutral-800 space-y-2">
              ...
              <p className="text-xs leading-relaxed font-semibold">
                To guarantee high-intensity operations and minimize custom-cut paper waste (production plates and custom configurations cannot be recovered once printed), PRINTBAZAAR operates under a strict **Zero Cash On Delivery (No-COD)** and **No-Returns / No-Refunds** policy on active machinery runs.
              </p>
            </div>
          </div>
          ...
          <div className="space-y-3">
            ...
            <p>
              To the maximum extent permitted by applicable law, in no event shall PRINTBAZAAR, its subsidiaries, directors, or officers be held liable for any indirect, incidental, punitive, or consequential damages. This includes but is not limited to: loss of revenue, print delays caused by raw material supply constraints, color shifts arising from device-rendering calibration mismatches, or shipping handling errors.
            </p>
          ...
          <div className="space-y-3">
            ...
            <p>
              We reserve the absolute right to suspend or terminate your account immediately if you breach any criteria defined in these terms. We may revise these terms at any time by updating this document online. Your continued use of the platform after any changes indicates your active consent.
            </p>
          </div>
